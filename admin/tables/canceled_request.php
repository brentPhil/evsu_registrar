<div class="table-responsive" style="min-height: 70vh">
    <table id="incompleteTB" class="table border-secondary-subtle h-100" style="width:100%">
...
<script>
    $(document).ready(function() {
        const incomplete = $('#incompleteTB').DataTable({
            responsive: true,
            columnDefs: [
        ...
        function applyFilter(columnIndex, selectedValue) {
            incomplete.search('').column(columnIndex).search(selectedValue, true, false).draw();
        }
